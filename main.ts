...
// let stripedName = "Ghulam\Mustafa";
// console.log(stripedName);
// let stripedName1 = " Ghulam\mustafa";
...
// let other  = ['mustafa' , 'waris' , 'hashir' , 'baba' , 'amir' ]
...
// let same = ['mustafa' , 'umar' , 'baba' , 'hashir' , 'umar' , ' basim']
...
// let ondinner = ["shafiq","umar","rahim"]
...
// let dinnersecond = ["mubashir","basim","hashir"]
...
// let Guest:string[] = ["hashir","amir","basit"];
// //Informing the guest that i found a bigger dinner table 
// Guest.map((i)=>console.log(`Dear ${i},I found a bigger dinner table.`));
// //add the guest in the beginning
// let guestFirst = "Gia";
...
// let locations = [ "saudiaforhaj" , "lasvegas" , "newyork" , "duabi"]
...
// let userNames:string[] = ["admin","mustafa","arif","amir","asif","baba"];
...
// const current_users:string[] = ["usman","baba","mustafa","asif","amir"];
// let new_users:string[] = ["ahmed","usman","mustafa","aslam","akram"];
// function checkuserName(current_users:string[],new_users:string[]):void{
//     const lowercaseCurrentuser = current_users.map(user => user.toLowerCase())
//     for(const newUser of new_users){
//         const lowercaseNewuser = newUser.toLowerCase();
//         if(lowercaseCurrentuser.includes(lowercaseNewuser)){
//             console.log(`username "${newUser}", has already taken.Enter a new username`)
//         }else{
...
// make_shirt("rehman", 11)
// make_shirt("mustafa" , 13)
...
//     return album;
// }
// const album1 = make_album("Ibrar ul Haq","Billo De Ghar");
// const album2 = make_album("Atif Aslam", "Tery Bin", 12);
// const album3 = make_album("Ali Azmat", "Garaj Baras Saawin", 3);
// console.log(album1)
// console.log(album2)
// console.log(album3)
...
// let magicianName = ["Harry Houdini","Criss Angel","David Coperfield","Derren Brown","Ricky Jay","Dynamo"];
// function show_magicians(items:string[]):void{
//     for( let i of items){
//         console.log(i)
//     }
// }
...
//     let GreatMagician:string[] = magicianName.map(magicianName =>The Great ${magicianName});
...
// const magiciansNames:string[]= ["Harry Houdini","Criss Angel","David Coperfield","Derren Brown","Ricky Jay","Dynamo"];   
...
//     const GreatMagictian:string[] = magiciansNames.map(magiciansNames=> 
//         The Great ${magiciansNames});
//         return GreatMagictian;
// }
// const GreatMagictianNames:string[]=make_great(magiciansNames);
// showMagicians(magiciansNames);
// showMagicians(GreatMagictianNames);
...
//     if(items.length === 0){
//         console.log("You order nothing. please add some items.");
//     }else{
...
// Sandwiches("BBQ", "Chicken Tikka", "Mayonaise","Cheesy");
// Sandwiches("Egg Sandwich", "Club Sandwich");
// Sandwiches("Honey","Tandori", "Cheese","Beef");
// Sandwiches();
...
// stored correctly.
//  function createCar(manufacturer:string, model:number, ...properties:[string,any][]):any{
//     const car:any = {
//         manufacturer,
//         model,
//     };
...
// }
// //example usage
// const myCar:string = createCar("Toyota Corolla", 2023, ["color", "red"],["optional Feature","Sunroof"],["Speed", "250 KM/hours"]);
// console.log(myCar);
